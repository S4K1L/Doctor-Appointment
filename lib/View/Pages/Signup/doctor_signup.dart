                          ...
                          child: Column(
                            children: [
                              ...
                              inputField(
                                  ...
                                  doctorSignupController.specialityController.value),
                              const SizedBox(height: 30),
                              inputField('Contact number', Icons.phone,
                                  doctorSignupController.phoneController.value),
                              const SizedBox(height: 30),
                              inputField('Compensation', Icons.attach_money_rounded,
                                  doctorSignupController.compensationController.value),
                              const SizedBox(height: 30),
                              inputField('Bio', Icons.mode_comment_rounded,
                                  doctorSignupController.bioController.value),
                              const SizedBox(height: 30),
                              inputField('Hospital', Icons.mode_comment_rounded,
                                  doctorSignupController.hospitalController.value),
                              const SizedBox(height: 30),
                              inputField('Address', Icons.mode_comment_rounded,
                                  doctorSignupController.addressController.value),
                              const SizedBox(height: 30),
